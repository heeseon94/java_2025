...
public class Collection003_Set {
	public static void main(String[] args) {
		...
		Set<Integer> set2 = new HashSet<>(); //int 숫자자료형, 객체만저장
		...
		System.out.println("1. add 2. size - " 	 + set.size());
		...
		for(Integer e1 : set2){System.out.println(set2);} //꺼내오기
		
		System.out.println();
		System.out.println();
		
		Iterator <Integer> iter = set2.iterator(); //2. 줄을서시오! iter → [1,3]
