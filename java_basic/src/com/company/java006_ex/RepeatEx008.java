...
public class RepeatEx008 {
	public static void main(String[] args) {
		...
		// ver-1 1이 3의 배수라면 합을 더해 변수에 누적
		//       2이 3의 배수라면 합을 더해 변수에 누적
		//       3이 3의 배수라면 합을 더해 변수에 누적
		
		// ver-2 if(1이 3의 배수라면) {합을 더해 변수에 누적}   if (1%3==0){ sum+=1;}
		//       if(2이 3의 배수라면) {합을 더해 변수에 누적}   if (2%3==0){ sum+=2;}
		//       if(3이 3의 배수라면) {합을 더해 변수에 누적}   if (3%3==0){ sum+=3;}
